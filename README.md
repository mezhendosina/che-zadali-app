![Main icon](https://user-images.githubusercontent.com/80736171/177765764-81a59151-8c47-47c6-b2cc-2e2ab2daaaf2.svg)
# SGO app (Beta)
...
## Что портировано?
- Дневник
- Отправка текстового домашнего задания
- Объявления
- Оценки
- Настройки профиля (80%)

## To-do 
- Сообщения 
- Уведомления о новом домашнем\просроченном задании
- Поддержка нескольких пользователей 
- Прикрепление файлов к домашнему заданию
