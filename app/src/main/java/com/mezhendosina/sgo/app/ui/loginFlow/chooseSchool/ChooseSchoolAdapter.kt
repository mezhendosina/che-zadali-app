...
class ChooseSchoolAdapter(private val onSchoolClickListener: OnSchoolClickListener) :
    ...
    override fun onClick(v: View?) {
        ...
        val oldValue = schools.indexOfFirst { it.id == selectedItemId }
        val newValue = schools.indexOfFirst { it.id == school.id }
        selectedItemId = school.id
